function sendContact()
{
	...
	$.ajax({
			...
			url: "http://localhost:8080/mobilestore/createContact",
			success: function(result){
				alert("Cảm ơn quý khách đã liên hệ với chúng tôi. Mobile Store sẽ phản hồi sớm cho các bạn");
				window.location.href = "/mobilestore/contact";
			},
			error : function(e){
				alert("Error: ",e);
				console.log("Error" , e );
