			...
			<%@page contentType="text/html" pageEncoding="UTF-8" %>
				...
				<body>
					...
					<div class="login-page">
						<div class="form">
							<h2 class="form-signin-heading" style="text-align: center">Mobile Store - Đăng nhập</h2>
							<hr>
							...
							<form class="login-form" method="POST" action="${contextPath}/login">
								...
								<p class="message" style="font-size: 18; padding-top:10px"> Chưa có tài khoản? <a
										href="<c:url value='/register'/> ">Tạo tài khoản mới</a></p>
							</form>
						</div>
					</div>
						...
						<div class="main-agileinfo">
							<div class="agileits-top">
								...
								<form method="POST" action="${contextPath}/login">
									<input class="text" type="text" name="email" placeholder="Tên đăng nhập" required>
